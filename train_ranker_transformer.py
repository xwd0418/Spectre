...
def add_parser_arguments( parser):
    ...
    parser.add_argument("--optional_MS",  type=lambda x:bool(str2bool(x)), default=False, help="also make mass spec as optional input")
    ...
    parser.add_argument("--use_MS",  type=lambda x:bool(str2bool(x)), default=True, help="using mass spectra")
...
from utils.interpret_NMR_input_config_args import parse_nmr_input_types
