...
ylabel = "% of correct annotation (containing a compound with >0.8 molecular similarity to truth compound)"
...
with open(save_dir + f"topk_annotation_with_mw_{model_number}.pkl", 'wb') as file:
    pickle.dump(mean_rank_records, file)
with open(save_dir + f"topk_annotation_without_mw_{model_number}.pkl", 'wb') as file:
