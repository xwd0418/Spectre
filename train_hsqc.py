...
from datasets.hsqc_dataset import HSQCDataModule
from pytorch_lightning.loggers import TensorBoardLogger
from models.hsqc_resnet import HSQCResnet
...
def main():
    ...
    path1, path2 = "lightning_logs", "hsqc_only"

    model = HSQCResnet()
    data_module = HSQCDataModule(batch_size=32)
