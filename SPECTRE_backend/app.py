...
sys.path.insert(0,'/root/MorganFP_prediction/reproduce_previous_works/smart4.5')
...
def hello():
    return build_actual_response(jsonify({'retrievals': "baga"}))

@app.route('/generate-retrievals', methods=['POST','OPTIONS'])
def generate_image():
